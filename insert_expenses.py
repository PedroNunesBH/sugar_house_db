...
def insert_expense(cursor, bd_connection):
    def insert_to_bd():
        ...
        print("Registro de despesa inserido com sucesso")
    ...
    label_title = Label(expense_window, text="Insira um registro de despesa", width=30, font=("Arial", 12, "bold"))
    label_title.place(x=50, y=20)

    labels = ["Descricao:", "Valor:", "Forma de Pagamento"]
